...
function createUserCard(user){
    ...
    <ul>
        ...
        <li>
            <i class="fa-solid fa-bookmark">${user.public_repos}</i><strong>Repository</strong>
        </li>
    </ul>
...
function createErrorCard(msg){
 ...
 async function getRepos(username){
    try{
     ...
     createErrorCard("malesef repolari cekerken hata olsutu :(")
    }
}
